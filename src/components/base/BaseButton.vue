...
File: BaseButton.vue
|-------------------------------------------------------------------------- | |
Description: | Reusable button component with support for loading, disabled
state, | preset colors, and custom styling. | | Responsibilities: | - Provide
consistent button UI across the app | - Handle loading + disabled states | -
Support preset and custom color styling | - Allow flexible content via props or
slots | | Notes: | - Use slots for complex content (icons, etc.) | - Loading
state automatically disables button | - Supports native button types (button,
submit, reset) | */
