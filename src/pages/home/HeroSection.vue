  ...
  <section class="p-4 bg-gray-50 min-h-screen">
    ...
    <div class="relative mb-6">
      <input
        ...
        class="w-full py-3 pl-12 pr-4 rounded-xl bg-white shadow-sm border border-gray-200 focus:outline-none"
      />
  <svg
...
<div class="flex gap-3 overflow-x-auto mb-8">
  <button
    class="px-6 py-2 rounded-full bg-green-700 text-white whitespace-nowrap"
  >
    All
  </button>
  <button
    class="px-6 py-2 rounded-full bg-gray-200 text-gray-700 whitespace-nowrap"
  >
    Starters
  </button>
  <button
...
<!-- Featured Card -->
<div
  class="relative overflow-hidden rounded-3xl h-72 mb-5"
>
  <img
  ...
  <div class="absolute bottom-6 left-6 text-white">
    <span
      class="inline-block px-4 py-1 bg-green-400 text-black rounded-full text-sm mb-3"
    >
      Bestseller
    </span>
