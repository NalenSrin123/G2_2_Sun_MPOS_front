		...
		<div class="hidden md:flex flex-col gap-2">
			<div
				...
				<div class="flex items-center gap-2 pr-4 pl-2">
					...
					<button
						@click="delete_Products(item.id)"
						:disabled="isDeleting === item.id"
						class="w-9 h-9 border border-gray-200 rounded-lg flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
						<svg
